...
export default async function QuotationsPage() {
  ...
  return <AppShell>
    <div className="flex flex-wrap items-start justify-between gap-5"><div><p className="text-sm font-semibold uppercase tracking-widest text-yellow-500">Comercial</p><h1 className="mt-1 text-3xl font-bold">Cotizaciones</h1></div><div className="flex flex-wrap items-center gap-3"><CommercialNav /><Link href="/commercial/quotations/new" className="rounded-xl bg-yellow-500 px-5 py-3 font-semibold text-black">Nueva cotización</Link></div></div>
